...
const hostname = process.env.HOSTNAME.endsWith('.local') ? process.env.HOSTNAME : process.env.HOSTNAME + '.local' || 'milionerzy.local';

const httpServer = createServer(app); // use express on web server
